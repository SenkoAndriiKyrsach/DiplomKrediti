...
export default function ManagerProductPage() {
  ...
  useEffect(() => {
    if (!isNew) {
      getCreditProductById(Number(productId)).then((data) => {
  ...
  const save = async () => {
    ...
    try {
      if (isNew) {
        ...
        navigate(`/manager/product/${res.product_id}`);
      } else {
      ...
      <div className="product-card">
        ...
        <div className="form-group">
          ...
          <input
            ...
            placeholder="Наприклад: Молодіжний, Бізнес, Авто"
            value={product.target_group || ""}
        ...
        <div className="form-group">
          ...
          <input
            ...
            max="100"
            step="0.1"
            placeholder="0 — без внеску"
            value={product.down_payment_pct}
        ...
        <div className="btn-block">
          <button className="btn-back" onClick={() => navigate("/manager/products")}>
            Назад
          </button>
